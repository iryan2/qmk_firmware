...
[_LOWER] = LAYOUT( \
  ...
  KC_LCTRL, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, KC_EQL,  KC_MINS, KC_HOME, KC_PGUP, KC_BSPC, KC_BSLS, \
  KC_LSFT,  DEV_ON,  _______, _______, _______, _______, _______, KC_DEL,  KC_END,  KC_PGDN, _______, KC_ENT, \
