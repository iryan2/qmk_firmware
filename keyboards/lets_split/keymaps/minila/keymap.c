...
#define CMD_LFT RGUI(KC_LEFT)
#define CMD_RGT RGUI(KC_RGHT)
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Enter |      |  Alt |  Cmd |Lower |Space |Space |Raise | Cmd  | Alt  | Ctrl |Enter |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  KC_ENT,  _______,KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RGUI, KC_RALT, KC_RCTRL, KC_ENT \
),

/* Lower
 * ,-----------------------------------------------------------------------------------.
 * |  `   |      |      |  Up  |      |      |      |      |Ps/SR | ScLk |Pa/Br | Del  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Ctrl |      | Left | Down |Right |      |  =   |   -  | Home | PgUp | Bksp |  \   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |Shift | Dev  |      |      |      |      |      | Del  | End  | PgDn |      |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |  Alt |  Cmd |      |             |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT( \
  KC_GRV,   _______, _______, KC_UP,   _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, KC_DEL, \
  KC_LCTRL, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, KC_EQL,  KC_MINS, CMD_LFT, KC_PGUP, KC_BSPC, KC_BSLS, \
  KC_LSFT,  DEV_ON,  _______, _______, _______, _______, _______, KC_DEL,  CMD_RGT,  KC_PGDN, _______, KC_ENT, \
...
[_RAISE] = LAYOUT( \
  ...
  KC_LSFT, _______,  _______, KC_LBRC, KC_RBRC, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, DEV_ON,  KC_RSFT, \
