 ...
 */
[_DEV] = LAYOUT( \
  _______, _______,  _______, ALT_RGT, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______,  _______, _______, VISUAL, ALT_LFT, _______, _______, _______, _______, _______, _______, \
  DEV_OFF, _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, DEV_OFF \
),

#define S_A_RGT LSFT(LALT(KC_RGHT))
#define S_A_LGT LSFT(LALT(KC_LEFT))
 ...
 */
[_VISUAL] = LAYOUT( \
  _______, _______,  _______, S_A_RGT, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______,  _______, _______, _______, S_A_LGT, _______, _______, _______, _______, _______, _______, \
  DEV_OFF, _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, DEV_OFF \
),
/* Dev - old idea for reference
 * ,-----------------------------------------------------------------------------------.
