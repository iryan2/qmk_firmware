...
[_LOWER] = LAYOUT( \
  ...
  KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS, KC_UP, KC_LBRC, KC_RBRC, KC_PIPE, \
...
[_RAISE] = LAYOUT( \
  ...
  KC_DEL,  KC_LPRN,   KC_LCBR,   KC_RCBR,   KC_RPRN,   KC_MINS,   KC_F6,   KC_MINS, KC_UP,  KC_LCBR, KC_RCBR, KC_BSLS, \
  _______, KC_DLR,   KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR,  KC_F12,  KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, \
